...
void
mouse_init(Mouse *mouse)
{
    memset(mouse, 0, sizeof(*mouse));
}

void 
mouse_pre_poll(Mouse *mouse)
{
...
void 
mouse_on_button_down(Mouse *mouse, const u8 button)
{
    mouse->current_buttons[button] = true;
}

void
mouse_on_button_up(Mouse *mouse, const u8 button)
{
    mouse->current_buttons[button] = false;
}

b8 
mouse_is_down(const Mouse *mouse, const u8 button)
{
    return mouse->current_buttons[button];
}

b8
mouse_is_pressed(const Mouse *mouse, const u8 button)
{
    return mouse->pressed_buttons[button];
}

b8
mouse_is_released(const Mouse *mouse, const u8 button)
{
