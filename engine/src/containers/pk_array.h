...
#define ARRAY_RESERVE(type, capacity) _array_create (capacity, sizeof (type))
...
#define ARRAY_POP(array, value_ptr) _array_pop (array, value_ptr)
...
#define ARRAY_CLEAR(array) _array_field_set (array, ARRAY_LENGTH, 0)

#define ARRAY_CAPACITY(array) _array_field_get (array, ARRAY_CAPACITY)

#define ARRAY_LENGHT(array) _array_field_get (array, ARRAY_LENGTH)

#define ARRAY_STRIDE(array) _array_field_get (array, ARRAY_STRIDE)
